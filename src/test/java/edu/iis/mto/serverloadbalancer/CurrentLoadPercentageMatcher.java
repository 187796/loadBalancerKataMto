...
public class CurrentLoadPercentageMatcher extends TypeSafeMatcher<Server> {
    ...
    protected boolean matchesSafely(Server server) {
        return doublesAreEqual(this.expectedLoadPercentage, server.getCurrentLoadPecentage());
    }
    ...
    protected void describeMismatchSafely(Server server, Description description) {
        description.appendText("server with load percentage of").appendValue(server.getCurrentLoadPecentage());
